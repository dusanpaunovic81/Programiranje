...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <%-- <div class="form-group text-primary">--%><br />
    <h2>Unos novog kredita</h2>
    <div id="odobren" class="h2" runat="server"></div>
    <br />
    ...
    <h2><div id="korisnik_poruka" runat="server"></div></h2><br /><br />
     <div class="col-4 jumbotron" style="padding:10px;width:400px;background-color:#f2f4f4; border:solid 1px; border-color:black;">
    ...
    <asp:TextBox ID="TextBox8" class="form-control" runat="server"></asp:TextBox><br /><br /></div>
